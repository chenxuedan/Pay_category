...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/chenxuedan/Pay_category.git", :tag => s.version.to_s }
  ...
  s.source_files  = "Pay_category/Source/**/*.{h,m,swift}"
